...
return [
    ...
    */
    ...
    'manual_migrations' => (bool) env('SHOPIFY_MANUAL_MIGRATIONS', 1),
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Delivery Estimator'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '4a8e478d7e7798129bcdbcd36aeccb4a'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '84ff758204cbebb34b44acb42a13ae7f'),
    ...
    'webhooks' => [
        ...
        */
        ...
        [
            ...
            'address' => env('APP_URL').env('SHOPIFY_WEBHOOK_1_ADDRESS', '/webhooks')
        ]
    ],
    ...
    */
    ...
    'scripttags' => [
        [
            'src' => env('APP_URL').env('SHOPIFY_SCRIPTTAG_1_SRC_END_URL', '/assets/js/dtimer.js'),
